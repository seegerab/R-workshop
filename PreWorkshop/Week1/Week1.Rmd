...
First, you can include a `?` in front of a function name. For example, if you want more information on the `str()` function - this is short for structure, and tells you more about the structure of a variable - the documentation should appear in the help() pane once you run the code chunk. This is helpful to see all of the function arguments. 
